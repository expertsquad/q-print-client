    ...
    <>
      <section className=" w-full">
        <div className="lg:border rounded-lg lg:p-7 flex flex-col gap-8">
          ...
          <button
            className="lg:text-lg text-base  text-white uppercase bg-gradient-to-r from-[#C83B62] to-[#7F35CD]  
 px-5 py-3.5 rounded lg:w-48 w-full hover:scale-105 hover:duration-500"
          >
            Update Profile
          </button>
        </div>
